...
# [DOC] SessionLocal, engine, Base: DB connectivity and schema management for the test fixture.
from database.connection import SessionLocal, engine, Base
from database.models.user import User
from database.models.transaction import Transaction, TransactionStatus
from database.models.block import BlockPublic, BlockPrivate
# [DOC] Aliased as UserSession to avoid confusion with Flask/SQLAlchemy Session objects.
from database.models.session import Session as UserSession
from database.models.bank import Bank

# [DOC] TransactionService (v1 — legacy): used here to test the Phase 2 consensus layer independently.
from core.services.transaction_service import TransactionService
# [DOC] MiningService: PoW miner that hashes pending transactions into a public block.
from core.consensus.pow.miner import MiningService
# [DOC] BankValidator: PoS consensus layer — each bank verifies nullifiers, range proofs, Merkle root, then signs.
